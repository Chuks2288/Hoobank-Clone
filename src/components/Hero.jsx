    ...
    return (
        ...
        <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-16 px-6`}>
                ...
                <div className="">
                    <h1 className='font-poppins font-semibold ss:text-[60px] text-[52px]
            ...
            <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
                ...
                <d className="absolute z-[1] w-[40%] h-[35%] top-0 pink__gradient" />
                <d className="absolute z-[2] w-[40%] h-[80%] rounded-full bottom-40 white__gradient" />
                <d className="absolute z-[1] w-[40%] h-[50%] right-20 bottom-20 blue__gradient" />
